...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/PurchaseOutstanding/create')}}">+ Add IMPORT INVOICE</a>
</div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header py-3 d-sm-flex d-block">
                    <h4 class="card-title mb-2">IMPORT BL Details</h4>
                </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive active-projects style-1">
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>AE/BSCPL/2222/2025-26</td>
                                    <td>4</td>
                                    <td>BSCPL/005/25-26</td>
                                    <td>01-05-2025</td>
                                    <td>25133213</td>
                                    <td>2025-26</td>
                                    <td>775-8014-4816</td>
                                    ...
                                    <td>False</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/PurchaseOutstanding/{id}/edit')}}">Edit</a>
