...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><a href="#">Add New Fixed Charge</a></li>
        </ol>
        <a href="{{url('admin/FixedCharge')}}" class="text-primary"><- Go Back</a>
    </div>
                        ...
                        <div class="form-validation">
                            <form class="needs-validation" novalidate>
                                <div class="row">
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">Fixed Charge ID:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">LCL/FCL:</label>
                                            <div class="col-sm-9 d-flex align-items-center">
                                                <select class="default-select form-control wide me-2"
                                                    placeholder="Select"></select>
                                                <button type="button" class="btn btn-sm btn-outline-primary"
                                    ...
                                    <div class="col-xl-6">
                                    <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">Charge Name:</label>
                                            <div class="col-sm-9 d-flex align-items-center">
                                                <select class="default-select form-control wide me-2"
                                                    placeholder="Select"></select>
                                                <button type="button" class="btn btn-sm btn-outline-primary"
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">RATE BASIS:</label>
                                            <div class="col-sm-9 d-flex align-items-center">
                                                <select class="default-select form-control wide me-2"
                                                    placeholder="Select"></select>
                                                <button type="button" class="btn btn-sm btn-outline-primary"
