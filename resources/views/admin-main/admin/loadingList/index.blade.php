...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/LoadingList/create')}}">+ ADD EXPORT BL</a>
</div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Active</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/LoadingList/{id}/edit')}}">Edit</a>
