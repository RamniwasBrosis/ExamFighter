...
@section('content')
    <div class="page-titles">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Productivity Report:</a></li>
        </ol>
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive active-projects shorting">
                                    ...
                                    <div class="tbl-caption">
                                        <h4 class="heading mb-0">Productivity Report</h4>
                                    </div>
                                    <table id="projects-tblss" class="table ItemsCheckboxSec">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>No Records Found in Productivity Report!</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
