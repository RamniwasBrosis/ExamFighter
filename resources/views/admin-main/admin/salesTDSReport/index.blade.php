...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/SalesTDSReport/create')}}">+ ADD PURCHASE INVOICE</a>
</div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>hjgfy</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/SalesTDSReport/{id}/edit')}}">Edit</a>
