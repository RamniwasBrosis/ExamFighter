...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/ProformaInvoice/create')}}">+ Add Proforma Invoice</a>
</div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>AIR EXPORTS</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/ProformaInvoice/{id}/edit')}}">Edit</a>
