...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/ExportBLDataEntry/create')}}">+ Add EXPORT BL</a>
</div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive active-projects style-1">
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>SE/BSCPL/2255/2025-26</td>
                                    <td>2255</td>
                                    <td>22559</td>
                                    <td>1/S.A.R.L. ART ET ANTIQUITIES</td>
                                    <td>BSCPL-2255</td>
                                    <td>BSC-2255</td>
                                    <td>Active</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/ExportBLDataEntry/{id}/edit')}}">Edit</a>
