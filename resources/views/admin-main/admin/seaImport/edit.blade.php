...
@section('content')
    <div class="page-titles">
        ...
        <a href="{{ url('admin/SeaImport') }}" class="text-primary"><- Go Back</a>
    </div>
                            ...
                            <form class="needs-validation" novalidate>
                                <div class="row">
                                    <div class="col-xl-6 col-xxl-6">
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">Discharge:<span
                                                    class="text-danger">*</span></label>
                                            <div class="col-sm-9 d-flex align-items-center">
                                                <select class="default-select form-control wide me-2"
                                                    placeholder="Select"></select>
                        ...
                        <div class="form-validation">
                            <form class="needs-validation" novalidate>
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-xxl-6">
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">Notify:<span
                                                    class="text-danger">*</span></label>
                                            <div class="col-sm-9 d-flex align-items-center">
                                                <select class="default-select form-control wide me-2"
                                                    placeholder="Select"></select>
