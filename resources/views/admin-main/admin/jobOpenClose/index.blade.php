...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/JobOpenclose/create')}}">+ Add Job</a>
</div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive active-projects style-1">
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>BSCPL/1690/AE/2023-24</td>
                                    <td>08/02/2025</td>
                                    <td>AE</td>
                                    <td>Close</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/JobOpenclose/{id}/edit')}}">Edit</a>
