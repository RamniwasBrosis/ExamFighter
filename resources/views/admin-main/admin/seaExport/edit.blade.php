...
@section('content')
    <div class="page-titles">
        ...
        <a href="{{ url('admin/SeaExport') }}" class="text-primary"><- Go Back</a>
    </div>
                        ...
                        <div class="form-validation">
                            <form class="needs-validation" novalidate>
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">CHA:<span
                                                    class="text-danger">*</span></label>
                                            <div class="col-sm-9 d-flex align-items-center">
                                                <select class="default-select form-control wide me-2"
                                                    placeholder="Select"></select>
                            ...
                            <form class="needs-validation" novalidate>
                                <div class="row">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <button class="btn btn-primary btn-sm" type="button">LOADING
                                            CONFIRMATION</button>
