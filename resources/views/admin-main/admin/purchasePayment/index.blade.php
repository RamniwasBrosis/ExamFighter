...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/PurchasePayment/create')}}">+ Add Purchase Payment</a>
</div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>wqfw</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/PurchasePayment/{id}/edit')}}">Edit</a>
