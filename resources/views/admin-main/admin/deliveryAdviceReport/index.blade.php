...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/DeliveryAdviceReport/create')}}">+ ADD IMPORT BL</a>
</div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>2025-26</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/DeliveryAdviceReport/{id}/edit')}}">Edit</a>
