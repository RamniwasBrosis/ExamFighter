...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/SalesInvoice/create')}}">+ Add Import Invoice</a>
</div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>False</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/SalesInvoice/{id}/edit')}}">Edit</a>
