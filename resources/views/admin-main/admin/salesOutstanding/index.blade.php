...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/SalesOutstanding/create')}}">+ ADD IMPORT INVOICE</a>
</div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Active</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/SalesOutstanding/{id}/edit')}}">Edit</a>
