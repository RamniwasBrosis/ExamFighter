...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/Transport/create')}}">+ Add Transport</a>
</div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>BSSKY-2240</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/Transport/{id}/edit')}}">Edit</a>
