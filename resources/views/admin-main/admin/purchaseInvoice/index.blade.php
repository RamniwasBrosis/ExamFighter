...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/PurchaseInvoice/create')}}">+ Add Purchase Invoice</a>
</div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>775-8014-4816</td>
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/PurchaseInvoice/{id}/edit')}}">Edit</a>
