...
<div class="page-titles">
    ...
    <a class="text-primary fs-13" href="{{url('admin/AirExport/create')}}">+ Add EXPORT AIR BL</a>
</div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a class="badge badge-info light border-0" href="{{url('admin/AirExport/{id}/edit')}}">Edit</a>
