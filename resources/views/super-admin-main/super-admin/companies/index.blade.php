...
<div class="page-titles">
    <ol class="breadcrumb">
        <li>
            <h5 class="bc-title">Companies</h5>
        </li>
    ...
    <a class="text-primary fs-13" href="{{ url('super-admin/companies/create') }}">Add Companies +</a>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header py-3 d-sm-flex d-block">
                    <h4 class="card-title mb-2">Companies</h4>
                </div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>3 weeks ago</td>
                                    <td>
                                        <a href="{{url('super-admin/companies/{id}/edit')}}" class="badge badge-info light border-0">Edit</a>
