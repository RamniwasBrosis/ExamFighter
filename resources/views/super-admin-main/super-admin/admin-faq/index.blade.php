...
<div class="page-titles">
    <ol class="breadcrumb">
        <li>
            <h5 class="bc-title">Admin FAQ</h5>
        </li>
    </ol>
    <a class="text-primary fs-13" href="{{url('super-admin/admin-faq/create')}}">Add FAQ +</a>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header py-3 d-sm-flex d-block">
                    <h4 class="card-title mb-2">Admin FAQ</h4>
                </div>
                        ...
                        <table id="empoloyees-tblwrapper" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Mohan</td>
                                    <td>super admin</td>
                                    <td>dwdrgaergrega hgfiuy hkgv</td>
                                    <td>
                                        <a href="{{url('super-admin/admin-faq/{id}/edit')}}" class="badge badge-info light border-0">Edit</a>
