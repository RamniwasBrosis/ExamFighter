<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a href="{{ url('super-admin/dashboard') }}" class="" aria-expanded="false">
                <div class="menu-icon">
            ...
            <li><a href="{{ url('super-admin/packages') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
            ...
            <li><a href="{{ url('super-admin/companies') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <li><a href="{{ url('super-admin/invoices') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <li><a href="{{ url('super-admin/admin-faq') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <span class="nav-text">Admin FAQ</span>
                </a>
            </li>
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                    ...
                    <span class="nav-text">Front Setting</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="{{ url('super-admin/contact-setting') }}">Contact Setting</a></li>
                    <li><a href="{{ url('super-admin/footer-setting') }}">Footer Setting</a></li>
                </ul>
            </li>
        </ul>
    </div>
